...
function main() {
    ...
    function create_button_group() {
        ...
        switch (true) {
            ...
            case !!document.getElementsByClassName('guide').length:
                function_buttons_package = document.getElementsByClassName('guide')[0];
                break;
