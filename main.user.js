...
(function () {
    ...
    if (GM_getValue('DISPLAY_BADGE') === true) {
        common_css += '.t_f img.badge,.t_f .zoom[src$="/public/images/patch.gif"]{display:block}';
    }
